...
require("nvim-dap-virtual-text").setup({
    ...
    virt_text_pos = 'eol', -- this piece of shaaaaat gave me so many issues with what was on the github page lol
...
-- You need ripgrep installed on machine for search by grep to work 
